	...
	<script type="text/javascript">
			    $(document).ready(function(){
					...
					$('#topmenu').hover(function(){
						$('.submenuBg').stop().animate({height: "230px", opacity : 1}, 500, function(){ $('#topmenu .submenu').shop().animate({ opacity : 1, height:'230px'}, 100); });
					 },function(){
					    $('#topmenu .submenu').shop().animate({ opacity : 0, height:'0px' }, 100, function(){
